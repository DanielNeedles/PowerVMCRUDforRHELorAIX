...
# PURPOSE: Test the managevm.py program which has the usage:         #
...
# NOTE:  RegEx for Python can be tested here: http://pythex.org/     #
######################################################################
declare -a arr=(
  './managevm.py vms' 
  './managevm.py images' 
  './managevm.py flavors' 
  './managevm.py networks'
  './managevm.py vms debug'
  './managevm.py images debug' 
  './managevm.py flavors debug' 
  './managevm.py networks debug'
  './managevm.py add testmanageAIX1 AIX72TL01SP01'
  './managevm.py add testmanageRHELbe1 "RHEL 7.2ppc64be"'
  './managevm.py add testmanageRHELle1 "RHEL 7.2ppc64le"'
  './managevm.py add testmanageAIX2 AIX72TL01SP01 2c710505-79f7-4021-b7f5-98e113c261d4'
  './managevm.py add testmanageRHELbe2 "RHEL 7.2ppc64be" powervm.tiny'
  './managevm.py add testmanageRHELle2 "RHEL 7.2ppc64le" powervm.small'
  './managevm.py add testmanageAIX3 AIX72TL01SP01 2c710505-79f7-4021-b7f5-98e113c261d4 bcb1fdae-3dad-4a52-8ece-f32418a8fd09'
  './managevm.py add testmanageRHELbe3 "RHEL 7.2ppc64be" powervm.tiny bcb1fdae-3dad-4a52-8ece-f32418a8fd09'
  './managevm.py add testmanageRHELle3 "RHEL 7.2ppc64le" powervm.small CSRA_Public'
  './managevm.py vms' 
  './managevm.py remove testmanageAIX1'
  './managevm.py remove testmanageRHELbe1'
  './managevm.py remove testmanageRHELle1'
  './managevm.py remove testmanageAIX2'
  './managevm.py remove testmanageRHELbe2'
  './managevm.py remove testmanageRHELle2'
  './managevm.py remove testmanageAIX3'
  './managevm.py remove testmanageRHELbe3'
  './managevm.py remove testmanageRHELle3'
  './managevm.py vms' 
)
